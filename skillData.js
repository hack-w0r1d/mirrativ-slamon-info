const SKILL_DATA = [
  {
    ...
    heartCost: 20,
    type: 'デバフスキル',
    description: '相手全員の守備力を約1/2にする。(検証中)',
  },
  {
    name: 'カチムキン',
    heartCost: 20,
  ...
  },
  {
    ...
    heartCost: 20,
    type: '状態異常',
    description: 'ダメージを与えつつしびれ状態にする。しびれ状態のモンスターは1~3ターンの間、行動不能になる。通常攻撃に比べて少し命中率が低い。',
  },
  {
    name: 'モード・バリア',
    heartCost: 20,
    type: 'バフスキル',
    description: 'HPが3/4以上ある時、最大HPの半分のダメージを受け、自分の守備力を2倍にする。',
  },
  {
    name: 'おやつのじかん',
    heartCost: 20,
  ...
  },
  {
    ...
    heartCost: 20,
    type: '物理攻撃',
    description: 'モンスター1体に攻撃力を約1.5倍にして攻撃。',
  },
  {
    name: 'ユルミノウタ',
    heartCost: 20,
  ...
  },
  {
    ...
    heartCost: 20,
    type: '物理攻撃',
    description: 'モンスター1体に攻撃力を0.7倍にしてダメージを与え、相手の攻撃力を0.8倍(検証中)にする。',
  },
  {
    name: 'ガオガオスラッシュ',
    heartCost: 20,
    type: '物理攻撃',
    description: 'モンスター1体にダメージを与えた後、自分の攻撃力を約1.2倍にする(検証中)。何度も使うと武器を失って攻撃がねこパンチになる。',
  },
  {
    name: 'ナイトメーア',
    heartCost: 20,
  ...
  },
  {
    ...
    heartCost: 15,
    type: '物理攻撃',
    description: '相手1体に攻撃力を約1.3倍にして攻撃。HPが高い時に発動確率が上がる。',
  },
  {
    name: 'おしつぶし',
    heartCost: 15,
    type: '物理攻撃',
    description: '相手1体に元々の攻撃力を約1.7倍にして攻撃。HPが低い時発動確率が上がる。',
  },
  {
    name: 'シビルト',
    heartCost: 20,
  ...
  },
  {
    ...
    heartCost: 20,
    type: '状態異常',
    description: 'モンスターを毒状態にし、毎ターン行動後最大HPの1/6ダメージ。ボス討伐においてかなり優秀。2~3回目で発動すれば必ず制限ターン内に決着がつく。',
  },
  {
    name: 'ムキムキン',
    heartCost: 10,
  ...
  },
  {
    ...
    heartCost: 30,
    type: 'デバフスキル',
    description: '「フニャルト」から進化。相手1体の守備力を約1/4にする(検証中)。',
  },
  {
    name: 'シオルト',
    heartCost: 10,
